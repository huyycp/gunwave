...
class GestureRecognizerService: NSObject {
  ...
  ///  This method processes a single frame (CMSampleBuffer) asynchronously.
  /// - Parameters:
  ///   - sampleBuffer: The video frame to be processed.
  ///   - orientation: The orientation of the frame.
  ///   - timeStamps: The timestamp in milliseconds when the frame was captured.
  func recognizeAsync(
...
extension GestureRecognizerService: GestureRecognizerLiveStreamDelegate {
  ...
  /// This method is called whenever the GestureRecognizer finishes processing a frame in livestream mode.
  /// - Parameters:
  ///   - gestureRecognizer: The gesture recognizer that finished recognizing the gesture.
  ///   - result: The result of the gesture recognition.
  ///   - timestampInMilliseconds: The timestamp in milliseconds when the gesture was recognized.
  ///   - error: An error that occurred during gesture recognition, if any.
